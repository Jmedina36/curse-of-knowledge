...
export const WIZARD_SKILL_TREE = [
  // ── Tier 1 ──────────────────────────────────────────────────────────
  {
    ...
    type: 'passive', icon: '/skills/wz_spellfire.png', bonus: { atk: 5 },
  },
  {
    ...
    type: 'passive', icon: '/skills/wz_arcane_veil.png', bonus: { maxSp: 15 },
  },
  // ── Tier 2 Left ─────────────────────────────────────────────────────
  {
    ...
    type: 'passive', icon: '/skills/wz_hex_mastery.png', bonus: { critChance: 12 },
  },
  {
    id: 'wz_mana_surge', name: 'Mana Surge',
    desc: '2.5× damage · guaranteed Burn · 3 turns', flavor: 'Flood the spell until it breaks.',
    tier: 2, branch: 'left', cost: 1, requires: ['wz_spellfire'],
    type: 'active', spCost: 30, icon: '/skills/wz_mana_surge.png',
  ...
  // ── Tier 3 ──────────────────────────────────────────────────────────
  {
    ...
    type: 'active', spCost: 40, icon: '/skills/wz_cataclysm.png',
  ...
  },
  {
    ...
    type: 'active', spCost: 35, icon: '/skills/wz_absolute_zero.png',
...
export const KNIGHT_SKILL_TREE = [
  // ── Tier 1 ──────────────────────────────────────────────────────────
  {
    ...
    tier: 1, branch: 'left', cost: 1, requires: [],
    type: 'passive', icon: '/skills/kn_battle_forged.png', bonus: { atk: 4 },
  },
  {
    id: 'kn_ironclad', name: 'Ironclad',
    desc: '+5 Defense', flavor: 'Your armor is your soul.',
    tier: 1, branch: 'right', cost: 1, requires: [],
    type: 'passive', icon: '/skills/kn_ironclad.png', bonus: { def: 5 },
  },
  // ── Tier 2 Left ─────────────────────────────────────────────────────
  {
    ...
    type: 'passive', icon: '/skills/kn_ravager.png', bonus: { critChance: 10 },
  },
  {
    id: 'kn_warlords_roar', name: "Warlord's Roar",
    desc: '+30% ATK · +15% Crit · 2 turns', flavor: 'Let them hear you.',
    tier: 2, branch: 'left', cost: 1, requires: ['kn_battle_forged'],
    type: 'active', spCost: 20, icon: '/skills/kn_warlords_roar.png',
  ...
  // ── Tier 2 Right ────────────────────────────────────────────────────
  {
    ...
    type: 'active', spCost: 20, icon: '/skills/kn_unbreakable.png',
  ...
  },
  {
    ...
    tier: 2, branch: 'right', cost: 1, requires: ['kn_ironclad'],
    type: 'active', spCost: 20, icon: '/skills/kn_rampart.png',
  ...
  // ── Tier 3 ──────────────────────────────────────────────────────────
  {
    ...
    type: 'active', spCost: 25, icon: '/skills/kn_no_quarter.png',
  ...
  },
  {
    ...
    type: 'active', spCost: 15, icon: '/skills/kn_retribution.png',
...
export const CRUSADER_SKILL_TREE = [
  // ── Tier 1 (mutually exclusive) ──────────────────────────────────────
  {
    ...
    tier: 1, branch: 'left', cost: 1, requires: [],
    type: 'passive', icon: '/skills/cr_storm_blessed.png', bonus: { atk: 5 },
  },
  {
    id: 'cr_bulwark', name: 'Bulwark',
    desc: '+8 DEF · all healing +20%', flavor: 'The shield is as sacred as the sword.',
    tier: 1, branch: 'right', cost: 1, requires: [],
    type: 'passive', icon: '/skills/cr_bulwark.png', bonus: { def: 8 },
  },
  // ── Tier 2 Left ─────────────────────────────────────────────────────
  {
  ...
  // ── Tier 2 Right ────────────────────────────────────────────────────
  {
    ...
    type: 'passive', icon: '/skills/cr_blessed_armor.png',
  },
  {
    ...
    tier: 2, branch: 'right', cost: 1, requires: ['cr_bulwark'],
    type: 'active', spCost: 25, icon: '/skills/cr_consecration.png',
  ...
  // ── Tier 3 ──────────────────────────────────────────────────────────
  {
    ...
    type: 'active', spCost: 40, icon: '/skills/cr_lightning_judgment.png',
  ...
  },
  {
    ...
    type: 'active', spCost: 35, icon: '/skills/cr_aegis_of_light.png',
...
export const ASSASSIN_SKILL_TREE = [
  // ── Tier 1 (mutually exclusive — picking one locks the other) ────────
  {
    ...
    tier: 1, branch: 'left', cost: 1, requires: [],
    type: 'passive', icon: '/skills/as_serrated_edge.png',
  },
  {
    ...
    tier: 1, branch: 'right', cost: 1, requires: [],
    type: 'passive', icon: '/skills/as_shadowstep.png', bonus: { critChance: 12 },
  },
  // ── Tier 2 Left ─────────────────────────────────────────────────────
  {
  ...
  // ── Tier 3 ──────────────────────────────────────────────────────────
  {
    ...
    type: 'active', spCost: 35, icon: '/skills/as_coup_de_grace.png',
  ...
  },
  {
    ...
    type: 'active', spCost: 40, icon: '/skills/as_phantom_strike.png',
