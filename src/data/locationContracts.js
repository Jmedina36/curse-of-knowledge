...
I don't know if that's enough. But it's done. For now.`,
  ...
  },
  {
    ...
    storyNote: "It didn't speak. There was no threat, no recognition, no acknowledgment that you were anything other than an obstacle in a timeline it had been tracking for decades. When it was over, the cavern was silent in a way that felt like something held its breath. The deal Malachar made is broken — or delayed. The order is gone. The debt remains. Somewhere, someone holds the C title now. The work isn't finished. It's just yours.",
    encounter: {
