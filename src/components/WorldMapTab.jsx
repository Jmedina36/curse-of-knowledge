...
const LOCATIONS = [
  ...
  {
    id: 'dusk_sanctum',
    name: 'The Dusk Sanctum',
    subtitle: "Mira's Cathedral",
    desc: "The Daughters built this over months while the order moved its other pieces into place. Mira never left.",
    marker: '/worldmap/stone-crystal.png',
    type: 'contract',
    contractZone: 4,
    unlockLevel: 8,
