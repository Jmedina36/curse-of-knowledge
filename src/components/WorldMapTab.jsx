...
const LOCATIONS = [
  ...
  },
  {
    ...
    type: 'contract',
    unlockDay: 1,
    position: { left: '70%', top: '86%' },
    danger: 1, dangerLabel: 'Tame', dangerColor: '#9CA3AF',
    contract: 'Missing Crew',
  },

  // ── GREEN ISLAND — Day 1-2 safe (bottom-left) ─────────────────────────────
  {
    id: 'canopy_outpost',
    name: 'Canopy Outpost',
    subtitle: 'Scout Post',
